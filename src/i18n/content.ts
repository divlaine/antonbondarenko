...
export const copy = {
  en: {
    ...
    role:'Senior iOS Developer', availability:'Samara, Russia · Open to remote work',
  ...
  ru: {
    ...
    role:'Senior iOS-разработчик', availability:'Россия, Самара · Готов к удаленной работе',
